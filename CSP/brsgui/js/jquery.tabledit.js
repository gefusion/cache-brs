        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<span class="glyphicon glyphicon-pencil btn-edit"></span>'
                },
                remove: {
            ...
            columns: {
                ...
                toolbox: function() {
                    if (settings.editButton || settings.removeButton) {
                        ...
                        // Create edit button.
                        if (settings.editButton) {
                            editButton = '<button type="button" class="tabledit-edit-button btn-edit ' + settings.buttons.edit.class + '" style="margin-left: 5px;">' + settings.buttons.edit.html + '</button>';
                            saveButton = '<button onclick="apply()" type="button" class="tabledit-save-button ' + settings.buttons.save.class + '" style="margin-left: 5px; display: none;">' + settings.buttons.save.html + '</button>';
